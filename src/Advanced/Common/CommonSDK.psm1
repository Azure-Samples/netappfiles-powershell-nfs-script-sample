...
.OUTPUT
    ANF account object
.EXAMPLE
    CreateNewANFAccount - resourceGroupName 'My-RG' -location 'WestUS' -netAppAccountName 'netapptestaccount'
#>
}
...
function CreateNewANFVolume
{
    ...
    $ExportPolicyRule.AllowedClients =$AllowedClientIP
    ...
    try
    {
        $NewANFVolume = New-AzNetAppFilesVolume -ResourceGroupName $TargetResourceGroupName `
            ...
            -ServiceLevel $ServiceLevelTier `
            -ProtocolType $VolumeProtocolType `
